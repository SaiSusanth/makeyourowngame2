...
function setup() {
  ...
  obstacle = Bodies.rectangle(displayWidth/3, displayHeight-75, 75, 75, obstacles_options);
  World.add(myWorld, obstacle);

  obstacle2 = Bodies.rectangle(displayWidth/5, displayHeight-75, 75, 75, obstacles_options);
